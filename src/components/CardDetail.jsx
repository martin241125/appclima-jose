...
const CardDetail = ({ loadingCard, showCard, weather, forecast }) => {
                        ...
                        <div className="card mb-3 mx-auto bg-dark text-light">
                            <div className="row g-0">
                                <div className="col-md-4">
                                    ...
                                    <h4 className="card-desc "><img src={iconUrl} alt="icon"/>{weather.weather[0].description}</h4>
                                    <img src="https://images.pexels.com/photos/7084351/pexels-photo-7084351.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" className="img-fluid rounded-start" alt="..."/>
                                </div>
